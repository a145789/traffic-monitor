...
| 文件                                             | 职责说明                                                                                           |
| :----------------------------------------------- | :------------------------------------------------------------------------------------------------- |
| [src/main.rs](src/main.rs)                       | 启动编排、UI 消息循环与消息路由、单例 Mutex 锁。                                                   |
...
| [src/window.rs](src/window.rs)                   | 窗口类注册与主窗口创建、任务栏查找、嵌入位置计算与动态更新。                                       |
...
| [src/update/mod.rs](src/update/mod.rs)           | 自动/手动检查更新业务编排、子进程协议、安装器启动、安装版目录判定、注册表开关读写。                |
...
| [src/util.rs](src/util.rs)                       | UTF-16 转换、MessageBox 弹窗封装、注册表读写、模块句柄、工作集修剪。                               |
